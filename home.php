...
<body class="landing">
    ...
    if (isset($_POST["searchBtn"])) {
        ...
        $sql = "SELECT * FROM emp_post WHERE emp_uName = '$encrypteduName' AND emp_write LIKE '%$search%' ORDER BY emp_dateTime DESC ";
        $result = $conn->query($sql);
        if ($result == NULL) {
            echo "<script>alert('No result found');window.location='home.php';</script>";
        }
    } else {
